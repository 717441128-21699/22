...
const STATUS_CONFIG: Record<AlertStatus, { label: string; color: string; bgColor: string; Icon: typeof Clock }> = {
  ...
  escalated: { label: '已升级', color: 'text-purple-400', bgColor: 'bg-purple-500/15', Icon: ChevronRight },
        ...
        <div className="lg:col-span-2 space-y-4 lg:space-y-6">
          <div className="glass-card p-5">
            <div className="flex items-start justify-between mb-4">
              ...
              <span className={cn('text-sm font-medium', typeCfg.color)}>
                {typeCfg.label}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-4 border-y border-white/10">
              ...
              <div>
                ...
                <p className={cn(
                  'text-sm font-medium',
                  alert.consecutiveDays >= 7 ? 'text-red-400' : alert.consecutiveDays >= 3 ? 'text-warning-400' : 'text-white'
                )}>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={cn(
                      ...
                      record.confirmed ? 'bg-eco-500/20 text-eco-300' : 'bg-warning-500/20 text-warning-400'
                    )}>
